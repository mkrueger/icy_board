...
| ICBSM | Editing users and groups, sorting and packing the user file and the bulk edits over a selection of users. Reports, index files and the user info file of the original have no equivalent here, and the security level tables built from upload/download ratios are not there yet. |
