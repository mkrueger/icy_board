...
| ICBSM | Editing users and groups, packing the user file and the bulk edits over a selection of users. Reports, index files and the user info file of the original have no equivalent here. |
