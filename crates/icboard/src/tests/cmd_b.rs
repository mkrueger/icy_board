...
fn test_blt_show2() {
    ...
    assert_eq!(
        output,
        "\u{1b}[1;33m(\u{1b}[31m1000\u{1b}[33m min. left) Main Board Command? \u{1b}[0mB 2\nBULLETIN2\n\n\u{1b}[1;33m(H)elp, (1-2), Bulletin List Command? \u{1b}[0m"
    );
}
...
fn test_blt_show12() {
    ...
    assert_eq!(
        output,
        "\u{1b}[1;33m(\u{1b}[31m1000\u{1b}[33m min. left) Main Board Command? \u{1b}[0mB 1 2\nBULLETIN1BULLETIN2\n\n\u{1b}[1;33m(H)elp, (1-2), Bulletin List Command? \u{1b}[0m"
    );
}
...
fn test_blt_a_subcommand() {
    ...
    assert_eq!(
        output,
        "\u{1b}[1;33m(\u{1b}[31m1000\u{1b}[33m min. left) Main Board Command? \u{1b}[0mB A\nBULLETIN1BULLETIN2\n\n\u{1b}[1;33m(H)elp, (1-2), Bulletin List Command? \u{1b}[0m"
    );
}
...
fn test_blt_exit() {
    ...
    assert_eq!(
        output,
        "\u{1b}[1;33m(\u{1b}[31m1000\u{1b}[33m min. left) Main Board Command? \u{1b}[0mB\n\n\u{7}\u{1b}[1;31mSorry, Sysop, no Bulletins are presently available.\n\n\u{1b}[32mPress (Enter) to continue? \u{1b}[0m\r\u{1b}[K\u{1b}[1;31m\u{1b}[33m(\u{1b}[31m1000\u{1b}[33m min. left) Main Board Command? \u{1b}[0m"
    );
}
