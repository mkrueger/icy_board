    ...
    pub fn start_import(&mut self) -> Res<()> {
        ...
        let ftn = FtnConfig {
            options: FtnOptions {
                ...
                re_address: self.data.fido_re_address,
                make_response: self.data.fido_make_response,
                area_fix_forwarding: self.data.fido_enable_area_fix,
                auto_add_passthru: self.data.fido_auto_add,
