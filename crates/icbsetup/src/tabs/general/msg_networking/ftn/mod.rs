    ...
    pub fn new(icy_board: Arc<Mutex<IcyBoard>>) -> Self {
        Self {
            page: IcbSetupMenuUI::new(SelectMenu::new(vec![
                ...
                MenuItem::new(5, 'F', get_text("fido_menu_routing")),
                MenuItem::new(6, 'G', get_text("fido_menu_freq_paths")),
                MenuItem::new(7, 'H', get_text("fido_menu_freq_restrictions")),
                MenuItem::new(8, 'I', get_text("fido_menu_freq_magic")),
                MenuItem::new(9, 'J', get_text("fido_menu_freq_deny")),
            ]))
    ...
    fn handle_key_press(&mut self, key: KeyEvent) -> PageMessage {
        ...
        if let Some(selected) = opt {
            ...
            return match selected {
                ...
                5 => PageMessage::OpenSubPage(Box::new(routes::RoutingConfiguration::new(board))),
                6 => PageMessage::OpenSubPage(Box::new(freq::FreqPathList::new(board))),
                7 => PageMessage::OpenSubPage(Box::new(options::freq(board))),
                8 => PageMessage::OpenSubPage(Box::new(freq::FreqMagicNames::new(board))),
                9 => PageMessage::OpenSubPage(Box::new(freq::FreqDenyList::new(board))),
                _ => PageMessage::None,
            };
        }
        PageMessage::None
