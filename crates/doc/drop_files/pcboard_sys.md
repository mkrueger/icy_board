...
text is CP437 and space-padded. Numeric fields are unsigned little-endian,
including fields whose legacy documentation describes signed values.
...
| 18 | 5 | text | `Local`, connect rate |
| 23 | 2 | `u16` | Internal user ID |
| 25 | 15 | CP437 | First name, space-padded |
| 40 | 12 | CP437 | `SECRET`, space-padded |
| 52 | 2 | `u16` | Login minutes since midnight |
| 54 | 2 | `u16` | Minutes elapsed since login, cast to `u16` |
| 56 | 5 | text | Login time as `HH:MM` |
| 61 | 2 | `u16` | `32767`, allowed minutes |
| 63 | 2 | `u16` | `32767`, allowed download KiB |
| 65 | 1 | `u8` | Conference if at most 255, otherwise `0` |
...
| 111 | 1 | `u8` | Internal node number, capped at 255 |
...
| 131 | 2 | `u16` | `1`, code page identifier |
...
| 146 | 2 | `u16` | Full internal node number |
