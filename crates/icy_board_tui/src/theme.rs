...
pub const THEME: Theme = Theme {
    ...
    app_title: Style::new().fg(WHITE).bg(DARK_BLUE).add_modifier(Modifier::BOLD),
    ...
    email: Email {
        tabs: Style::new().fg(MID_GRAY).bg(DARK_BLUE),
        tabs_selected: Style::new().fg(WHITE).bg(DARK_BLUE).add_modifier(Modifier::BOLD),
    ...
    traceroute: Traceroute {
        header: Style::new().bg(DARK_BLUE).add_modifier(Modifier::BOLD).add_modifier(Modifier::UNDERLINED),
    ...
    recipe: Recipe {
        ...
        ingredients_header: Style::new().add_modifier(Modifier::BOLD).add_modifier(Modifier::UNDERLINED),
    },
};
