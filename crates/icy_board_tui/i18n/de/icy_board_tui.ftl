# Aktionsnamen für typisierte Tastaturhinweise. Tasten/Symbole stehen in Rust.
# Alte vollständige Fußzeilen bleiben während der Umstellung erhalten.
hotkey_help = Hilfe
hotkey_back = Zurück
hotkey_exit = Beenden
hotkey_edit = Ändern
hotkey_new = Neu
hotkey_delete = Löschen
hotkey_select = Wählen
hotkey_up = Auf
hotkey_down = Ab
hotkey_move = Sortieren
hotkey_browse = Durchsuchen
hotkey_search = Suchen
hotkey_filter = Filtern
hotkey_restore = Original
hotkey_save = Sichern
hotkey_apply = Übernehmen
hotkey_cancel = Abbrechen
hotkey_confirm = Bestätigen
hotkey_close = Schließen
hotkey_continue = Weiter
hotkey_scroll = Scrollen
hotkey_page = Seite
hotkey_first = Anfang
hotkey_last = Ende
hotkey_import = Import
hotkey_load = Laden
hotkey_copy = Kopieren
hotkey_history = Verlauf
hotkey_refresh = Neu laden
hotkey_field = Feld
hotkey_next_field_or_choice = Nächstes Feld
hotkey_run = Ausführen
hotkey_preview = Vorschau
hotkey_sort = Sortieren
hotkey_reverse_order = Reihenfolge umkehren
hotkey_keep_filter = Filter behalten
hotkey_clear_filter = Filter löschen
hotkey_jump = Springen
hotkey_next_style = Nächster Stil
hotkey_previous_style = Voriger Stil
hotkey_new_door = Neues Door
hotkey_edit_doors = Doors
hotkey_edit_bbslink = BBSLINK
hotkey_edit_events = Ereignisse
hotkey_areas = Bereiche
hotkey_monitor = Überwachen
hotkey_reset_stats = Zurücksetzen
hotkey_source = Quelle
hotkey_follow = Folgen
hotkey_warnings_errors = Warnungen/Fehler
hotkey_pan = Horizontal
hotkey_filter_context = Filter/Kontext
hotkey_next_match = Nächster Treffer
hotkey_previous_match = Voriger Treffer
hotkey_request_run = Start anfordern
hotkey_refresh_history = Verlauf neu laden
hotkey_older = Älter
hotkey_newer = Neuer
hotkey_scroll_details = Details scrollen
hotkey_output = Ausgabe
...
# Anruf-Warteschirm
call_wait_screen_user_button=Benutzer
call_wait_screen_user_button_descr=Lokale Benutzeranmeldung öffnen. Netzwerkdienste laufen weiter.
call_wait_screen_sysop_button=Sysop
call_wait_screen_sysop_button_descr=Lokal als Sysop anmelden. Netzwerkdienste laufen weiter.
call_wait_screen_exit_button=Beenden
call_wait_screen_exit_button_descr=IcyBoard und seine Dienste beenden; öffnet keine Shell.
call_wait_screen_log_button=Protokollansicht
call_wait_screen_log_button_descr=Anwendungs- und Anrufprotokoll lesen, neue Zeilen verfolgen und suchen.
call_wait_screen_status_button=Systemstatus
call_wait_screen_status_button_descr=Laufzeit, tatsächliche lokale Listener und freien Speicherplatz anzeigen.
call_wait_screen_event_monitor_button=Event Monitor
call_wait_screen_event_monitor_button_descr=Ereignisse und ihren Verlauf anzeigen und eines sofort ausführen.
...
# Schreibgeschützte Protokollansicht
log_view_title = Protokollansicht
log_view_app = Anwendung
log_view_caller = Anrufprotokoll
log_view_file = Ereignisausgabe (UTF-8)
log_view_keys = Tab Quelle  F Folgen  E Warn./Fehler  / Filter  Esc Zurück
log_view_caller_keys = Tab Quelle  F Folgen  / Suche  Esc Zurück
log_view_file_keys = F Folgen  / Suche  Esc Zurück
log_view_navigation = ↑↓ Scrollen  Bild↑↓ Seite  Pos1/Ende Anfang/Ende  ←→ Seitlich
log_view_search_keys = Enter Übernehmen  Esc Abbrechen
log_view_follow = Folgen ein
log_view_paused = Pausiert (eingefrorener Stand)
log_view_warnings = Nur Warnungen/Fehler
log_view_all = Alle Stufen
log_view_search = Filter
log_view_search_edit = Suche bearbeiten
log_view_context = Kontext
log_view_matches = Treffer
log_view_mode_keys = T Filter/Kontext  n Nächster  N Voriger Treffer (umlaufend)
log_view_tail = Nur lesend: 256 KiB / 2000 Zeilen / 2048 Zeichen je Zeile; Folgen alle 1s
log_view_size = Größe
log_view_mtime = Geändert (UTC)
log_view_unknown = Unbekannt
log_view_metadata_unavailable = Dateimetadaten nicht verfügbar
log_view_rotated = Datei ersetzt/rotiert
log_view_truncated = Datei verkürzt
log_view_read_error = Protokoll nicht lesbar
log_view_unconfigured = Kein Protokollpfad konfiguriert.
log_view_regular_only = Nur reguläre Dateien; keine Symlinks oder Spezialdateien.
log_view_empty = Keine Zeilen mit den aktuellen Filtern anzuzeigen.
log_view_loading = Protokoll wird geladen…
log_view_redacted = [Eintrag mit Webadmin-Token ausgeblendet]

# Schreibgeschützter Systemstatus; lokale Listener, keine Erreichbarkeitsprüfung
system_status_title = Systemstatus
system_status_keys = ↑↓ Scrollen  Bild↑↓ Seite  Pos1/Ende Anfang/Ende  Esc Zurück
system_status_uptime = Laufzeit (Tage hh:mm:ss)
system_status_admission = Neue Anmeldungen
system_status_admission_open = Erlaubt
system_status_admission_closed = Gesperrt
system_status_nodes = Nodes (aktiv/gesamt)
system_status_root = Board-Stammverzeichnis
system_status_disk = Speicher (verfügbar/gesamt GiB; % verfügbar)
system_status_disk_low = Wenig Speicherplatz
system_status_maintenance = Wartung
system_status_failure = Laufzeitfehler
system_status_request_error = Anfragefehler
system_status_online_event = Online-Ereignis
system_status_listeners = Tatsächliche lokale Listener (keine öffentliche Erreichbarkeitsprüfung)
system_status_telnet = Telnet
system_status_ssh = SSH
system_status_websocket = Sicherer WebSocket
system_status_admin = Webverwaltung
system_status_configured = Konfiguriert
system_status_running = Läuft lokal
system_status_running_closed = Gebunden; Anmeldungen gesperrt
system_status_state_age = Zustandsalter
system_status_stopped = Gestoppt
system_status_not_started = Nicht gestartet
system_status_enabled = Aktiviert
system_status_disabled = Deaktiviert
system_status_unavailable = Nicht verfügbar
system_status_none = Keine
system_status_waiting = Wartet
system_status_draining = Wartet auf Sitzungsende
system_status_stopping = Dienste werden gestoppt
system_status_executing = Befehl läuft
system_status_reloading = Board wird neu geladen
system_status_reload_failed = Neuladen fehlgeschlagen
system_status_listener_failed = Listener-Start fehlgeschlagen
system_status_restarting = Dienste werden neu gestartet
system_status_redacted = [Vertrauliche Angaben ausgeblendet]
system_status_config_sample = Konfigurationsstand
system_status_runtime_sample = Laufzeitstand
system_status_nodes_sample = Node-Stand
system_status_disk_sample = Speicherstand
system_status_fresh = Aktuell
system_status_stale = Veraltet
system_status_busy = Belegt
system_status_read_failed = Lesen fehlgeschlagen
system_status_pending = Ausstehend
system_status_never = Noch keine erfolgreiche Abfrage
...
external_editor_title = Externer Nachrichteneditor
external_editor_mode = Editor
external_editor_mode-status = Vollbildeditor fuer Nachrichten auswaehlen
external_editor_mode-help = Intern verwendet den eingebauten Editor. Programm startet eine Anwendung, Shell-Skript ein Skript, DOS einen DOS-Editor und PPE einen kompilierten PPL-Editor. Die Benutzerauswahl zwischen Zeilen- und Vollbildeditor bleibt erhalten.
external_editor_mode_internal = Intern
external_editor_mode_program = Programm
external_editor_mode_script = Shell-Skript
external_editor_mode_dos = DOS
external_editor_mode_ppe = PPE
external_editor_path = Programm oder DOS-Verzeichnis
external_editor_path-status = Programm-/Skript-/PPE-Pfad oder DOS-Installationsverzeichnis
external_editor_path-help = DOS verwendet pro Aufruf eine Kopie dieses Verzeichnisses. Editor und FOSSIL-Startbatch darin vorher konfigurieren. Die anderen Modi verwenden die angegebene Datei.
external_editor_arguments = Argumente / DOS-Befehl
external_editor_arguments-status = Argumente; DOS erwartet die vollstaendige Befehlszeile
external_editor_arguments-help = Platzhalter: { "{work}" } Austauschverzeichnis, { "{node}" } Node, { "{baud}" } Geschwindigkeit, { "{time}" } Minuten. Argumente mit Leerzeichen in Anfuehrungszeichen setzen. PPE erhaelt das Austauschverzeichnis als erstes GETTOKEN-Argument.
external_editor_dropfile = Benutzer-Dropfile
external_editor_dropfile-status = Benutzer-/Sitzungsdatei fuer den externen Editor
external_editor_dropfile-help = MSGINF und MSGTMP werden immer erzeugt. EXITINFO.BBS liefert zusaetzlich DORINFO1.DEF fuer RA-Editoren. PPE braucht kein Benutzer-Dropfile. RESULT.ED ist eine optionale Ausgabedatei.
external_editor_timeout = Maximale Laufzeit (Sekunden)
external_editor_timeout-status = Maximale Editorlaufzeit, begrenzt durch die verbleibende Sitzungszeit
external_editor_timeout-help = Bei Zeitlimit oder Verbindungsabbruch wird der Entwurf nie automatisch versendet. Bei ICE Edit die Option Errorlevels auf Yes setzen, damit Speichern und Abbruch unterscheidbar sind.
external_editor_memory = DOS-Speicher (MB)
external_editor_memory-status = Arbeitsspeicher fuer den DOS-Editor
external_editor_memory-help = Nur fuer DOS-Editoren. DOS-Assets vorher mit icbsetup dos-image vorbereiten.
...
msg_networking_zconnect=ZCONNECT-Konfiguration
zconnect_menu-help=Eigenständiges ZCONNECT-Netz mit Verbindungen und JAM-Zuordnungen einrichten. Dies ist kein Fido-Transport.
zconnect_general=Allgemeine Einstellungen
zconnect_general-help=ZCONNECT-Kennung und Paketverzeichnisse festlegen. Bei der ersten Änderung wird ohne Dateipfad zconnect.toml gewählt. Änderungen bleiben zunächst im Speicher; erst das Speichern der Board-Einstellungen schreibt sie auf die Festplatte.
zconnect_links=Verbindungen
zconnect_links-status=Einfg: neu; Enter: bearbeiten; Entf: löschen; F2: Bereiche; F1: Hilfe.
zconnect_links-help=Jede Verbindung beschreibt ein entferntes System und dessen Zugangsdaten. Einfg legt eine Verbindung an und öffnet den Editor; Enter bearbeitet sie; Entf löscht sie samt Zuordnungen. F2 öffnet die Bereichszuordnungen aus Liste oder Editor. Esc kehrt zurück. Zum dauerhaften Übernehmen die Board-Einstellungen speichern.
zconnect_areas=Bereichszuordnungen
zconnect_areas-status=Remote-Brettnamen lokalen JAM-Basen zuordnen; nur lesen empfängt nur.
zconnect_areas-help=Einfg legt eine Zuordnung an; Enter bearbeitet sie; Entf löscht sie. Den genauen Remote-Brettnamen einem lokalen JAM-Basispfad zuordnen (ohne .jhr/.jdt). Nur lesen empfängt Nachrichten, exportiert aber keine lokalen Beiträge. Esc kehrt zurück. Zum dauerhaften Übernehmen die Board-Einstellungen speichern.
zconnect_link_editor=ZCONNECT-Verbindung
zconnect_area_editor=ZCONNECT-Bereichszuordnung
zconnect_form_keys=Auf/Ab: Feld  Links/Rechts: Auswahl  F1: Hilfe  Esc: zurück
zconnect_link_keys=Auf/Ab: Feld  Enter: Profil  F2: Bereiche  F1: Hilfe  Esc: zurück
zconnect_links_keys=Einfg: neu  Enter: ändern  Entf: weg  F2: Bereiche  F1: Hilfe  Esc: zurück
zconnect_areas_keys=Einfg: neu  Enter: ändern  Entf: löschen  F1: Hilfe  Esc: zurück
zconnect_yes=Ja
zconnect_no=Nein
zconnect_enabled=Aktiviert
zconnect_enabled-status=Eigenständiges ZCONNECT-Netz ein- oder ausschalten.
zconnect_enabled-help=Mit Leertaste oder Links/Rechts umschalten. Vor dem Mailer-Einsatz einen vollständigen lokalen Systemnamen und Verbindungen einrichten. Beim Aktivieren wird ohne Dateipfad zconnect.toml gewählt.
zconnect_local_system=Lokales System (FQDN)
zconnect_local_system-status=Vollständiger lokaler Domainname, z.B. bbs.example.org.
zconnect_local_system-help=Den mit der Gegenstelle vereinbarten vollständigen Domainnamen des eigenen Systems eingeben. Er identifiziert das Board beim ZCONNECT-Austausch; keine FTN-Adresse oder URL verwenden.
zconnect_local_user=Lokaler Benutzer
zconnect_local_user-status=Lokale ZCONNECT-Benutzerkennung (Standard: sysop).
zconnect_local_user-help=Lokalen Benutzernamen zur Identifikation dieses Systems beim ZCONNECT-Austausch eingeben. Standard ist sysop. Zugangsdaten der Gegenstelle werden separat pro Verbindung festgelegt.
zconnect_config_file=Konfigurationsdatei
zconnect_config_file-status=Separate Einstellungsdatei; leer bedeutet zconnect.toml.
zconnect_config_file-help=Speicherort der ZCONNECT-Einstellungen wählen. Relative Pfade beziehen sich auf das Board-Verzeichnis. Leeren setzt beim Bearbeiten zconnect.toml ein und verwirft keine Einstellungen. Die Datei wird beim Speichern der Board-Einstellungen geschrieben.
zconnect_inbound=Eingangsverzeichnis
zconnect_inbound-status=Verzeichnis für empfangene ZCONNECT-Pakete.
zconnect_inbound-help=Verzeichnis für eingehende Pakete wählen. Relative Pfade beziehen sich auf das Board-Verzeichnis. Von ausgehenden Paketen und lokalen JAM-Nachrichtenbasen getrennt halten.
zconnect_outbound=Ausgangsverzeichnis
zconnect_outbound-status=Verzeichnis für ausgehende ZCONNECT-Pakete.
zconnect_outbound-help=Verzeichnis für ausgehende Pakete wählen. Relative Pfade beziehen sich auf das Board-Verzeichnis. Von eingehenden Paketen und lokalen JAM-Nachrichtenbasen getrennt halten.
zconnect_id=Verbindungskennung
zconnect_id-status=Eindeutige Kennung für dieses entfernte System.
zconnect_id-help=Eine eindeutige, nicht leere Verbindungskennung eingeben. Einen beständigen Namen zur Auswahl der Gegenstelle im Mailer verwenden. Diese Kennung ist unabhängig von TCP-Host und Anmeldename.
zconnect_host=Host
zconnect_host-status=TCP-Hostname oder IP-Adresse der Gegenstelle, ohne URL-Schema.
zconnect_host-help=Hostnamen, DNS-Alias oder IP-Adresse zum Anwählen eingeben, ohne telnet:// oder Port. Die Adresse muss nicht dem SYS-Anzeigenamen der Gegenstelle entsprechen. Leer bedeutet nur Offline-Austausch.
zconnect_remote_system=Erwartetes Peer-SYS
zconnect_remote_system-status=Optionaler SYS-Anzeigename der Gegenstelle; leer deaktiviert den Namensvergleich.
zconnect_remote_system-help=Optional den erwarteten SYS-Anzeigenamen der Gegenstelle eingeben (maximal 255 druckbare ASCII-Zeichen, keine Zeilenumbrüche). Der Vergleich ignoriert ASCII-Groß-/Kleinschreibung. Leer akzeptiert jeden nichtleeren Peer-SYS. Dies ist weder die Anwahladresse noch kryptografische Authentifizierung; ein vertrauenswürdiges Netz oder einen sicheren Tunnel verwenden.
zconnect_port=TCP-Port
zconnect_port-status=TCP-Port der Gegenstelle, 1–65535 (Standard: 23).
zconnect_port-help=TCP-Empfangsport der Gegenstelle festlegen. Standard ist 23. Nur Werte von 1 bis 65535 werden angenommen.
zconnect_username=Benutzername
zconnect_username-status=Anmeldekonto bei dieser Gegenstelle.
zconnect_username-help=Unser vom Partner vergebenes Systemkonto, gesendet als SYS bei der Aushandlung und als JANUS-Systemname. Leer verwendet den lokalen vollqualifizierten Systemnamen. Nachrichtenadressen bleiben unverändert.
zconnect_password=Passwort
zconnect_password-status=Passwort der Gegenstelle; auf dem Bildschirm maskiert.
zconnect_password-help=Passwort des entfernten Kontos eingeben. Im Editor maskiert, aber in der Konfiguration im Klartext gespeichert und über Telnet im Klartext übertragen. Dateirechte schützen und ein vertrauenswürdiges Netz oder einen sicheren Tunnel verwenden.
zconnect_login=Anmeldeprofil
zconnect_login-status=Enter: zconnect, janus oder direct wählen (Standard: zconnect).
zconnect_login-help=Enter drücken, mit Auf/Ab das vereinbarte Profil wählen und mit Enter bestätigen: zconnect, janus oder direct. Esc bricht die Auswahl ab. Direct ist für Gegenstellen, die ohne interaktive Anmeldung das Protokoll starten. Dies ist ein Anmeldeprofil, kein FTN-Transport.
zconnect_timeout=Zeitlimit (Sekunden)
zconnect_timeout-status=Verbindungs-/Protokoll-Zeitlimit in Sekunden (1-3600; Standard: 60).
zconnect_timeout-help=Verbindungs-/Protokoll-Zeitlimit von 1 bis 3600 Sekunden festlegen (Standard: 60). Der Wert wird ohne Begrenzung auf 30 Sekunden verwendet. Separate endliche Anmelde-/Transferfristen und Wiederholungslimits gelten weiterhin.
zconnect_remote_board=Remote-Brett
zconnect_remote_board-status=Genauer Brett-/Bereichsname bei dieser Gegenstelle.
zconnect_remote_board-help=ZCONNECT-Brettnamen der Gegenstelle für diese Zuordnung eingeben. Den vereinbarten Namen verwenden, keine lokale Konferenznummer. Jedes Remote-Brett pro Verbindung nur einmal zuordnen.
zconnect_local_area=Lokale JAM-Basis
zconnect_local_area-status=Pfad zur lokalen JAM-Nachrichtenbasis, ohne Dateiendung.
zconnect_local_area-help=Lokalen JAM-Basispfad eingeben, z.B. messages/general (nicht messages/general.jhr). Relative Pfade beziehen sich auf das Board-Verzeichnis. Der Pfad muss zum vorgesehenen lokalen Nachrichtenbereich gehören.
zconnect_read_only=Nur lesen
zconnect_read_only-status=Nur empfangen; keine lokalen Nachrichten für diese Zuordnung senden.
zconnect_read_only-help=Mit Leertaste oder Links/Rechts umschalten. Wenn aktiviert, werden Nachrichten vom entfernten Brett importiert, aber keine lokalen Nachrichten dorthin exportiert.
...
event_runtime_next_column = Kandidat
event_runtime_candidate = Nächster Zeitplankandidat
event_runtime_schedule_off = Automatischer Zeitplan ist ausgeschaltet.
event_runtime_event_off = Dieses Ereignis ist für automatische Starts deaktiviert.
event_runtime_invalid = Ungültige Ereigniseinstellungen
event_runtime_no_days = Keine Wochentage gewählt.
event_runtime_wrong_day = Heute ist kein gewählter Wochentag.
event_runtime_window_ended = Das heutige Fenster für den spätesten Start ist vorbei.
event_runtime_window_waiting = Fälliges Wartungsfenster; wartet (Laufzeitstand).
event_runtime_unnamed = Ereignis
...
event_runtime_duration = Dauer
event_runtime_elapsed = Verstrichen
event_runtime_exit_code = Exit-Code
event_runtime_timing_hint = Zeit ab Startversuch im Journal; kein Nachweis der Prozesslaufzeit.
    Ausstehend: verstrichen; unterbrochen/Wartefehler/fehlende Zeiten: unbekannt.
event_runtime_candidate_hint = Kandidat: künftiger Zeitplanslot, keine Startgarantie oder Rückstandsanzeige.
    Wochentage und tägliche Startfenster gelten; keine Datumsbereichseinstellung.
event_runtime_manual = Manuell
event_runtime_scheduled = Zeitplan
event_runtime_log = Protokoll
event_runtime_log_none = Für den gewählten Lauf ist kein Ausgabeprotokoll erfasst.
event_runtime_log_missing = Ausgabeprotokoll oder event_logs fehlt oder ist nicht lesbar.
event_runtime_log_invalid = Ungültiger Ausgabepfad; nur reguläre Dateien direkt unter event_logs erlaubt.
