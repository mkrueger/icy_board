//! An unfinished attempt at polling a ZConnect system, kept because the block
//! handling in it is the only working example of that protocol in the tree.
#![allow(dead_code)]
