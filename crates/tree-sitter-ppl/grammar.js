...
const BUILTIN_STATEMENTS = [
  ...
  'SETFONT', 'LOADFONT', 'ERRCLR', 'SETPALETTECOLOR', 'RESETPALETTECOLOR', 'RESETPALETTE',
  'BEGINTERMINALUPDATE', 'ENDTERMINALUPDATE', 'RECORDMACRO', 'ENDMACRO', 'PLAYMACRO', 'DELETEMACRO', 'CLEARMACROS',
];
...
const BUILTIN_TYPES = [
  ...
  'AREA', 'CONFERENCE', 'CONTACT', 'DIRECTORY', 'DOOR', 'ERROR', 'EVENT', 'PASSWORD', 'TERMINFO', 'TERMSTATE',
];
...
const BUILTIN_CONSTANTS = [
  ...
  'ERR_KIND_STACK', 'ERR_KIND_GFX', 'ERR_KIND_FONT', 'ERR_KIND_SOUND', 'ERR_KIND_TERM', 'FONT_ALL',
  ...
  'MOUSE_TEXT', 'MOUSE_PIXELS', 'MOUSE_NONE', 'MOUSE_PRESS', 'MOUSE_RELEASE', 'MOUSE_MOTION',
  'MOUSE_WHEEL', 'MOUSE_LEFT', 'MOUSE_MIDDLE', 'MOUSE_RIGHT', 'MOUSE_WHEEL_UP', 'MOUSE_WHEEL_DOWN',
  'MOUSE_SHIFT', 'MOUSE_ALT', 'MOUSE_CTRL', 'MOUSE_TRACK_BUTTONS', 'MOUSE_TRACK_DRAG', 'MOUSE_TRACK_ALL',
  'KEY_EVENTS_OFF', 'KEY_EVENTS_ON', 'KEY_EVENTS_SUPPRESS',
  'GFX_FLIP_NONE', 'GFX_FLIP_X', 'GFX_FLIP_Y',
  'EVENT_NONE', 'EVENT_KEY', 'EVENT_KEY_EDGE', 'EVENT_MOUSE', 'EVENT_OVERFLOW', 'EVENT_SOUND',
  ...
  'EVENT_SHIFT', 'EVENT_ALT', 'EVENT_CTRL', 'EVENT_META',
