...
const BUILTIN_STATEMENTS = [
  ...
  'FDWRITE', 'FDEFIN', 'FDEFOUT', 'FFLUSH', 'FGET', 'FGETREC', 'FOPEN', 'FPCLR', 'FPUT', 'FPUTLN', 'FPUTPAD', 'FPUTREC',
  'FREAD', 'FREADREC', 'FREALTUSER', 'FREWIND', 'FSEEK', 'FWRITE', 'FWRITEREC', 'FLAG', 'FORWARD', 'FRESHLINE',
  ...
  'WRUNET', 'WRUSYSDOOR', 'WAIT', 'WAITFOR',
];
...
const BUILTIN_TYPES = [
  ...
  'AREAS', 'AUDIO', 'CONFERENCES', 'CONTACTS', 'DIRECTORIES', 'DOORS', 'NOTES', 'REGEXMATCHES', 'SURFACE', 'USERS',
  'AREA', 'BOARD', 'CONFERENCE', 'CONTACT', 'DIRECTORY', 'DOOR', 'ERROR', 'EVENT', 'GFX', 'HTTP', 'HTTPREQUEST', 'HTTPRESPONSE', 'MACROS', 'MARGINS', 'MSG', 'PALETTE', 'PASSWORD', 'REGEX', 'REGEXMATCH', 'REGEXOPTIONS', 'STRINGCOMPARISON', 'SESSION', 'TERMINAL', 'USER', 'TERMINFO', 'TERMINPUT',
  'ERRCODE', 'ERRKIND', 'EVENTKIND', 'GFXBACKEND', 'HTTPMETHOD', 'MOUSEACTION', 'MOUSEBUTTON', 'MOUSEMODE', 'MOUSETRACKING', 'EDITORMODE', 'MSGFIELD',
];
