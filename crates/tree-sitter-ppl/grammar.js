...
const BUILTIN_TYPES = [
  ...
  'AREA', 'BOARD', 'CONFERENCE', 'CONTACT', 'DIRECTORY', 'DOOR', 'ERROR', 'EVENT', 'GFX', 'HTTP', 'HTTPREQUEST', 'HTTPRESPONSE', 'MACROS', 'MARGINS', 'MSG', 'PALETTE', 'PASSWORD', 'REGEX', 'REGEXMATCH', 'REGEXOPTIONS', 'SESSION', 'TERMINAL', 'USER', 'TERMINFO', 'TERMINPUT',
