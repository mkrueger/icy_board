...
const BUILTIN_TYPES = [
  ...
  'AREA', 'BOARD', 'CONFERENCE', 'CONTACT', 'DIRECTORY', 'DOOR', 'ERROR', 'EVENT', 'GFX', 'MACROS', 'MARGINS', 'MSG', 'PALETTE', 'PASSWORD', 'SESSION', 'TERMINAL', 'USER', 'TERMINFO', 'TERMINPUT',
  'ERRCODE', 'ERRKIND', 'EVENTKIND', 'GFXBACKEND', 'MOUSEACTION', 'MOUSEBUTTON', 'MOUSEMODE', 'MOUSETRACKING', 'EDITORMODE', 'MSGFIELD',
];
