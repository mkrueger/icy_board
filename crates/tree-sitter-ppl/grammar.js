...
const BUILTIN_TYPES = [
  'BIGSTR', 'BOOLEAN', 'BYTE', 'BYTES', 'DATE', 'DDATE', 'DOUBLE', 'DREAL', 'DWORD', 'EDATE', 'FLOAT', 'TIMESTAMP',
  'INTEGER', 'INT', 'LONG', 'ULONG', 'MONEY', 'MSGAREAID', 'REAL', 'SBYTE', 'SDWORD', 'SHORT', 'STRING',
  'SWORD', 'TIME', 'UBYTE', 'UDWORD', 'UNSIGNED', 'UWORD', 'WORD',
  'AUDIO', 'SURFACE', 'SURVEY',
  'AREA', 'BOARD', 'BULLETIN', 'CONFERENCE', 'CONTACT', 'DIRECTORY', 'DOOR', 'ERROR', 'EVENT', 'FILEENTRY', 'FILEPAGE', 'GFX', 'HTTP', 'HTTPREQUEST', 'HTTPRESPONSE', 'MACROS', 'MARGINS', 'MSG', 'MSGHEADER', 'PALETTE', 'PASSWORD', 'REGEX', 'REGEXMATCH', 'REGEXOPTIONS', 'STRINGCOMPARISON', 'SESSION', 'TERMINAL', 'USER', 'TERMINFO', 'TERMINPUT',
  ...
  'ZIP', 'ZIPWRITER', 'ZIPMETHOD', 'ZIP64MODE', 'ZIPENCODING',
];
