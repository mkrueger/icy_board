...
const BUILTIN_TYPES = [
  ...
  'AREAS', 'AUDIO', 'CONFERENCES', 'CONTACTS', 'DIRECTORIES', 'DOORS', 'NOTES', 'SURFACE', 'USERS',
  'AREA', 'BOARD', 'CONFERENCE', 'CONTACT', 'DIRECTORY', 'DOOR', 'ERROR', 'EVENT', 'GFX', 'HTTP', 'HTTPREQUEST', 'HTTPRESPONSE', 'MACROS', 'MARGINS', 'MSG', 'PALETTE', 'PASSWORD', 'SESSION', 'TERMINAL', 'USER', 'TERMINFO', 'TERMINPUT',
