...
use icy_board_engine::executable::{FuncOpCode, FunctionDefinition, OpCode, VariableType, FUNCTION_DEFINITIONS, LAST_PPLC, STATEMENT_DEFINITIONS};
...
fn get_statement_hover(opcode: OpCode) -> Option<Hover> {
    let sig = STATEMENT_DEFINITIONS[opcode as usize].get_signature();
    match opcode {
        ...
        OpCode::DECLARE => get_sig_hint(sig, fl!(LANGUAGE_LOADER, "hint-statement-declare")),
        OpCode::FUNCTION => get_sig_hint(sig, fl!(LANGUAGE_LOADER, "hint-statement-function")),
        OpCode::PROCEDURE => get_sig_hint(sig, fl!(LANGUAGE_LOADER, "hint-statement-procedure")),
        OpCode::PCALL => get_sig_hint(sig, fl!(LANGUAGE_LOADER, "hint-statement-pcall")),
        OpCode::FPCLR => get_sig_hint(sig, fl!(LANGUAGE_LOADER, "hint-statement-fpclr")),
        OpCode::BEGIN => get_sig_hint(sig, fl!(LANGUAGE_LOADER, "hint-statement-begin")),
        OpCode::FEND => get_sig_hint(sig, fl!(LANGUAGE_LOADER, "hint-statement-fend")),
        OpCode::STATIC => get_sig_hint(sig, fl!(LANGUAGE_LOADER, "hint-statement-static")),
        ...
        OpCode::EVAL => get_sig_hint(sig, fl!(LANGUAGE_LOADER, "hint-statement-eval")),
