...
export class MockRuntime extends EventEmitter {
	...
	public async start(program: string, stopOnEntry: boolean, debug: boolean): Promise<void> {
		var file_name = this.normalizePathAndCasing(program);
		let orange = vscode.window.createOutputChannel("PPL");

		orange.appendLine("Exec " + file_name);
		await execSync('pplc ' + file_name);
		await execSync('icy_board --ppe ' + file_name);
	}
