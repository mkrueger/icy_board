...
hint-regex-is-match=Prüft ab einer optionalen 1-basierten Unicode-Zeichenposition auf einen Treffer.
hint-regex-find=Liefert den ersten Treffer ab einer optionalen 1-basierten Unicode-Zeichenposition.
hint-regex-find-all=Liefert Treffer ab einer optionalen Startposition. Ein positives Limit begrenzt die Anzahl; null erlaubt bis zu 100.000 Treffer.
hint-regex-replace=Ersetzt alle Treffer oder höchstens ein positives Limit und unterstützt `$1`- und `$name`-Gruppen.
hint-regex-split=Teilt Text in ein dynamisches eindimensionales Stringarray. Leere Felder bleiben erhalten; ein positives Limit belässt den Rest im letzten Element.
hint-regex-match-success=Gibt an, ob ein Treffer gefunden wurde.
hint-regex-match-value=Der vollständige Treffertext.
hint-regex-match-start=Die 1-basierte Unicode-Zeichenposition des Treffers oder null ohne Treffer.
...
hint-regex-match-group-start=Liefert die 1-basierte Unicode-Zeichenposition der Gruppe oder null, wenn sie nicht beteiligt war.
