...
hint-function-gfx-api=Fragt Grafik-Backend, Fähigkeiten, Oberfläche, Geometrie oder Fehlerstatus ab.
hint-function-mouse-api=Fragt Mausereignisse, Koordinaten und den aktuellen Mausmodus ab.
...
hint-function-key-api=Fragt ein physisches CTerm-Tastenereignis ab.
