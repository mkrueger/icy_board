...
hint-type-http-request=Mutable HTTP request. `SetHeader` and `SetText` change this request and return whether they succeeded.
...
hint-http-request-set-text=Sets this request's UTF-8 body and optional content type, returning whether it succeeded. GET and HEAD requests return `FALSE`; `Error.Last()` reports the failure.
