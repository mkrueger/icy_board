...
fn test_constants() {
    ...
    assert_eq!(Token::Const(Constant::Unsigned(0xFF00_00FF, NumberFormat::Hex)), get_token("0FF0000FFh"));
    assert_eq!(
        Token::Const(Constant::Unsigned(142_9496_7296u64, NumberFormat::Default)),
