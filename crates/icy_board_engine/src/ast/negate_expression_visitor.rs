...
impl AstVisitorMut for NegateExpressionVisitor {
    ...
    fn visit_binary_expression(&mut self, expr: &super::BinaryExpression) -> Expression {
        match expr.get_op() {
            ...
            super::BinOp::NotEq => {
                BinaryExpression::create_empty_expression(super::BinOp::Eq, expr.get_left_expression().clone(), expr.get_right_expression().clone())
            }
            super::BinOp::Lower => {
                BinaryExpression::create_empty_expression(super::BinOp::GreaterEq, expr.get_left_expression().clone(), expr.get_right_expression().clone())
            }
            super::BinOp::LowerEq => {
                BinaryExpression::create_empty_expression(super::BinOp::Greater, expr.get_left_expression().clone(), expr.get_right_expression().clone())
            }
            super::BinOp::Greater => {
                BinaryExpression::create_empty_expression(super::BinOp::LowerEq, expr.get_left_expression().clone(), expr.get_right_expression().clone())
            }

            super::BinOp::GreaterEq => {
                BinaryExpression::create_empty_expression(super::BinOp::Lower, expr.get_left_expression().clone(), expr.get_right_expression().clone())
            }
