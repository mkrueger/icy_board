...
pub async fn run_function(opcode: FuncOpCode, arg: &mut VirtualMachine<'_>, arguments: &[PPEExpr]) -> Res<VariableValue> {
    match opcode {
        ...
        FuncOpCode::SIN => predefined_functions::sin(arg, arguments).await,
        FuncOpCode::COS => predefined_functions::cos(arg, arguments).await,
        FuncOpCode::TAN => predefined_functions::tan(arg, arguments).await,
        FuncOpCode::ATAN => predefined_functions::atan(arg, arguments).await,
        FuncOpCode::LOG => predefined_functions::log(arg, arguments).await,
        FuncOpCode::SQRT => predefined_functions::sqrt(arg, arguments).await,
        FuncOpCode::StringFindFrom => predefined_functions::string_find_from(arg, arguments).await,
        FuncOpCode::StringFindLastFrom => predefined_functions::string_find_last_from(arg, arguments).await,
        FuncOpCode::StringContains => predefined_functions::string_contains(arg, arguments).await,
        FuncOpCode::StringStartsWith => predefined_functions::string_starts_with(arg, arguments).await,
        FuncOpCode::StringEndsWith => predefined_functions::string_ends_with(arg, arguments).await,
        FuncOpCode::StringCount => predefined_functions::string_count(arg, arguments).await,
        FuncOpCode::StringTrim => predefined_functions::string_trim(arg, arguments).await,
        FuncOpCode::StringTrimStart => predefined_functions::string_trim_start(arg, arguments).await,
        FuncOpCode::StringTrimEnd => predefined_functions::string_trim_end(arg, arguments).await,
        FuncOpCode::StringJoin => predefined_functions::string_join(arg, arguments).await,
        FuncOpCode::StringRepeat => predefined_functions::string_repeat(arg, arguments).await,
        FuncOpCode::StringTrimChars => predefined_functions::string_trim_chars(arg, arguments).await,
        FuncOpCode::StringTrimStartChars => predefined_functions::string_trim_start_chars(arg, arguments).await,
        FuncOpCode::StringTrimEndChars => predefined_functions::string_trim_end_chars(arg, arguments).await,
        FuncOpCode::StringCharAt => predefined_functions::string_char_at(arg, arguments).await,
        FuncOpCode::StringFindComparison => predefined_functions::string_find_comparison(arg, arguments).await,
        FuncOpCode::StringFindLastComparison => predefined_functions::string_find_last_comparison(arg, arguments).await,
        FuncOpCode::StringContainsComparison => predefined_functions::string_contains_comparison(arg, arguments).await,
        FuncOpCode::StringStartsWithComparison => predefined_functions::string_starts_with_comparison(arg, arguments).await,
        FuncOpCode::StringEndsWithComparison => predefined_functions::string_ends_with_comparison(arg, arguments).await,
        FuncOpCode::StringCountComparison => predefined_functions::string_count_comparison(arg, arguments).await,
        FuncOpCode::StringEquals => predefined_functions::string_equals(arg, arguments).await,
        ...
        FuncOpCode::StringSubstring => predefined_functions::string_substring(arg, arguments).await,
        FuncOpCode::StringPadLeft => predefined_functions::string_pad_left(arg, arguments).await,
        FuncOpCode::StringPadLeftChar => predefined_functions::string_pad_left_char(arg, arguments).await,
        FuncOpCode::StringPadRight => predefined_functions::string_pad_right(arg, arguments).await,
        FuncOpCode::StringPadRightChar => predefined_functions::string_pad_right_char(arg, arguments).await,
        FuncOpCode::StringRemove => predefined_functions::string_remove(arg, arguments).await,
        FuncOpCode::StringInsert => predefined_functions::string_insert(arg, arguments).await,
        FuncOpCode::StringReverse => predefined_functions::string_reverse(arg, arguments).await,
        FuncOpCode::StringToInt => predefined_functions::string_to_int(arg, arguments).await,
        FuncOpCode::StringToMixedCase => predefined_functions::string_to_mixed_case(arg, arguments).await,
        FuncOpCode::StringStripAtx => predefined_functions::string_stripatx(arg, arguments).await,
        ...
        FuncOpCode::EnumHas => {
            ...
            let mask = arg.eval_expr(&arguments[2]).await?;
            if !arg.variable_table.enums.contains_key(&id) {
