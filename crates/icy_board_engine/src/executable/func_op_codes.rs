...
impl FunctionDefinition {
    ...
    pub fn parameter_count(&self) -> usize {
        match self.signature {
            FunctionSignature::FixedParameters(len) => len,
            _ => 0,
        }
    }
}
pub static FUNCTION_DEFINITIONS: std::sync::LazyLock<[FunctionDefinition; 366]> = std::sync::LazyLock::new(|| {
    [
        ...
        FunctionDefinition {
            ...
            return_type: VariableType::Integer,
            args: None,
            signature: FunctionSignature::UnaryOp,
        },
        FunctionDefinition {
            name: "UMINUS",
            version: 100,
        ...
        FunctionDefinition {
            ...
            return_type: VariableType::Integer,
            args: None,
            signature: FunctionSignature::BinaryOp,
        },
        FunctionDefinition {
            name: "TIMES",
            version: 100,
        ...
        FunctionDefinition {
            ...
            args: Some(vec![ArgumentDefinition::new("value", VariableType::UnboundedString)]),
            signature: FunctionSignature::FixedParameters(1),
        },
        FunctionDefinition {
            name: "Rgb",
