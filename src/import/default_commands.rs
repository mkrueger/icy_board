...
pub fn add_default_commands(data: &PcbBoardData, cmd_list: &mut CommandList) {
    cmd_list.push(convert_cmd(
        ...
        data.user_levels.cmd_a,
    ));
    cmd_list.push(convert_cmd(
        &["B"],
        CommandType::BulletinList,
        data.user_levels.cmd_b,
    ));
    cmd_list.push(convert_cmd(
        &["C"],
        CommandType::CommentToSysop,
        data.user_levels.cmd_c,
    ));
    cmd_list.push(convert_cmd(
    ...
    cmd_list.push(convert_cmd(
        ...
        data.user_levels.cmd_e,
    ));
    cmd_list.push(convert_cmd(
        &["F"],
        CommandType::FileDirectory,
        data.user_levels.cmd_f,
    ));
    ...
    cmd_list.push(convert_cmd(
        &["G", "BYE", "BY"],
        CommandType::Goodbye,
        data.user_levels.cmd_g,
    ));

    cmd_list.push(convert_cmd(
        &["H", "HELP", "HEL", "HE", "?"],
        CommandType::Help,
        data.user_levels.cmd_h,
    ));
    cmd_list.push(convert_cmd(
        &["IW"],
        CommandType::InitialWelcome,
        data.user_levels.cmd_i,
    ));
    cmd_list.push(convert_cmd(
        &["J", "JOIN", "JOI", "JO"],
        CommandType::JoinConference,
        data.user_levels.cmd_j,
    ));
    cmd_list.push(convert_cmd(
        &["I"],
    ...
    cmd_list.push(convert_cmd(
        ...
        data.user_levels.cmd_l,
    ));
    cmd_list.push(convert_cmd(
        &["M"],
        CommandType::ToggleGraphics,
        data.user_levels.cmd_m,
    ));
    cmd_list.push(convert_cmd(
        &["N"],
        CommandType::NewFileScan,
        data.user_levels.cmd_n,
    ));
    cmd_list.push(convert_cmd(
        &["O"],
        CommandType::PageSysop,
        data.user_levels.cmd_o,
    ));
    cmd_list.push(convert_cmd(
        &["P"],
        CommandType::SetPageLength,
        data.user_levels.cmd_p,
    ));
    cmd_list.push(convert_cmd(
        &["Q"],
        CommandType::QuickMessageScan,
        data.user_levels.cmd_q,
    ));
    cmd_list.push(convert_cmd(
        &["R"],
        CommandType::ReadMessages,
        data.user_levels.cmd_r,
    ));
    cmd_list.push(convert_cmd(
        &["S"],
        CommandType::Survey,
    ...
    cmd_list.push(convert_cmd(
        ...
        data.user_levels.cmd_u,
    ));
    cmd_list.push(convert_cmd(
        &["V"],
        CommandType::ViewSettings,
        data.user_levels.cmd_v,
    ));
    cmd_list.push(convert_cmd(
        &["W"],
        CommandType::WriteUserSettings,
        data.user_levels.cmd_w,
    ));
    cmd_list.push(convert_cmd(
        &["X"],
        CommandType::ExpertMode,
        data.user_levels.cmd_x,
    ));
    cmd_list.push(convert_cmd(
        &["Y"],
        CommandType::PersonalMail,
        data.user_levels.cmd_y,
    ));
    cmd_list.push(convert_cmd(
        &["Z"],
        CommandType::ZippyDirectoryScan,
        data.user_levels.cmd_z,
    ));

    cmd_list.push(convert_cmd(
        &["CHAT", "CHA", "CH"],
        CommandType::GroupChat,
        data.user_levels.cmd_chat,
    ));
    cmd_list.push(convert_cmd(
    ...
    cmd_list.push(convert_cmd(
        ...
        data.user_levels.cmd_test_file,
    ));
    cmd_list.push(convert_cmd(
        &["USER", "USE", "US"],
        CommandType::UserList,
        data.user_levels.cmd_show_user_list,
    ));
    cmd_list.push(convert_cmd(
        &["WHO", "WH"],
